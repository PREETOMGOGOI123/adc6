<section class="container mx-auto p-4 mt-20 bg-slate-700/20 rounded-md">
    <div class="bg-slate-950/70 border border-white/10 rounded-2xl p-10">

        <!-- Header -->
        <h1 class="text-3xl font-bold tracking-wide text-center">
            📅 ADC 6.0 Detailed Schedule
        </h1>

        <p class="text-white/70 mt-3 leading-7 text-center">
            Monkey Temple Trail Race • Official Weekend Timings
        </p>
