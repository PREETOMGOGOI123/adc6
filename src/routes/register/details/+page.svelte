...
<!--                    Welcome back, <b>{registrationStore.existingUser.name}</b>-->
<!--                </p>-->
<!--            </div>-->

<!--            &lt;!&ndash; Details Grid &ndash;&gt;-->
...
<!--                <p><b>Emergency:</b> {registrationStore.existingUser.emergency}</p>-->
